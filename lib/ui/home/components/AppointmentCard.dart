...
import 'package:zeta/ui/appointmentdetails.dart';
...
class AppointmentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
        decoration: BoxDecoration(
          ...
          color: AppColors.light["appointmentBackground"],
                                ...
                                children: <Widget>[
                                  Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      color:
                                          AppColors.light["appointmentTitle"],
                                    ),
                                  ),
                                  SizedBox(
                                    height: 5,
  ...
  String _getClass() {
    switch (this.appointment.subjects[0].toString()) {
      case "falt":
        return "Frans";
        break;
      case "du":
      ...
      case "ne":
        ...
        break;
      default:
        return this.appointment.subjects[0].toString() + "???";
        break;
    }
  }
}
